...
<template>
    ...
    <view class="goods">
      ...
      <view class="preview">
        <swiper circular @change="onChange">
          <swiper-item @tap="onPrevImg(item)" v-for="item in goodsDetail?.mainPictures" :key="item">
  ...
  <uni-popup ref="popupRef" type="bottom" background-color="#fff">
    <AddressPanel @close="popupRef?.close()" v-if="popupName === 'address'" />
    <ServicePanel @close="popupRef?.close()" v-if="popupName === 'service'" />
  </uni-popup>
</template>
